...
func main(){
	...
	flag.StringVar(&command, "c", "C:\\Windows\\System32\\cmd.exe", "Set the command or binary to be used for persistence")
	flag.StringVar(&argu, "a", "", "Set the arguments for the command")
	...
	flag.StringVar(&serviceName, "n", "updater", "Specify the service name to be created/removed for service persistence")
	...
	} else if technique == "service" {
		techniques.ServicePersist(command, argu, serviceName, method)
	} else {
